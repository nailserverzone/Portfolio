...
export const FUN_FACTS = [
  ...
  "I have 5 cats and 1 munchkin kitten 🐱",
  "Home is Jakarta, lived in Vancouver 🌏",
  "Travelled to LA, SF, Singapore, KL, Makkah, Madinah & Victoria BC ✈️",
  "My bias is Yoongi 🐱",
  "My favorite Pokémon is Espeon 💜",
  "Currently learning about vibecoding 🎵",
